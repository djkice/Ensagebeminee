...
namespace ODSharp
{
    ...
    internal class Program
    {
        ...
        private static Item bkb, hex, orchid, shiva, atos, blood;
        ...
        public static void Game_OnUpdate(EventArgs args)
        {
            ...
            if (atos == null)
                atos = me.FindItem("item_rod_of_atos");
                   ...
                   if (blood == null)
                blood = me.FindItem("item_bloodthorn");
            ...
            if (Combo)
            {
                ...
                if (target != null && target.IsAlive && !target.IsInvul() && !target.IsIllusion)
                {
                    ...
                    if (blood != null && blood.IsValid && blood.CanBeCasted() && Utils.SleepCheck("blood") && menuValue.IsEnabled(blood.Name))
                    {
                        blood.UseAbility(target);
                        Utils.Sleep(150 + Game.Ping, "blood");
                        return;
                    }
